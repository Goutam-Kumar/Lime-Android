...
internal class VehiclesAdapter(val context: Context, var listItemsTxt: List<Vehicle>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.text = listItemsTxt[position].make.plus(" ").plus(listItemsTxt[position].model)
        return view
    }
